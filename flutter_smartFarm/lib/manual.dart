...
import 'package:flutter_firebase/CustomDatabase.dart';
...
class Manual extends StatefulWidget {
  Manual({this.app, Key key, @required this.title, @required this.channel})
      : super(key: key);
...
AppBar buildAppBar(BuildContext context) {
  return AppBar(
    ...
    actions: <Widget>[
      IconButton(
        icon: SvgPicture.asset("assets/icons/auto.svg"),
